...
fn main() -> io::Result<()> {
    ...
    CompressionSettings::default().content_checksum(true).block_checksums(true).independent_blocks(true)/*.dictionary(0, &vec![0u8; 64 * 1024])*/.compress_with_size(file_in, file_out)?;
